...
class Apriltag {
   ...
   */
    constructor(onDetectorReadyCallback) {
        ...
        // detector options
        this._opt = {
          // Decimate input image by this factor (1.0 = no decimation, more accurate but slower)
          quad_decimate: 1.0,
        ...
        let _this = this;
        console.log("Starting to load AprilTag WASM...");
     ...
     */
    onWasmInit(Module) {
        console.log("onWasmInit called, this =", this);
        ...
        console.log("Module.buffer:", Module.buffer);
    ...
    detect(grayscaleImg, imgWidth, imgHeight) {
        console.log("detect called, this =", this, "this._Module =", this._Module);
        if (!this._Module) {
